...
* **source**, contains the information about the source Database (_it’s **Mandatory**_):
    * **format**: the format of the source Database (i.e. Snoflake, Neo4j, RedShift…). _It’s **Mandatory**_
    ...
    * **limit**: limits the number of rows retuned from the source data, it’s good for testing purposes. _It’s Optional_
...
* **target**, contains the information about the target Database (_it’s **Mandatory**_):
    * **format**: the format of the target Database (i.e. Snoflake, Neo4j, RedShift…). _It’s **Mandatory**_
...
val connector = new Neo4jDWHConnector(spark, config)
